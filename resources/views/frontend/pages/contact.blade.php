                    ...
                    @include('frontend.partials.messages')
                        ...
                        @csrf
                          <div class="row">
                            ...
                            <div class="col-lg-6 col-md-12 col-sm-12">
                              <fieldset>
                                <input name="phonenumber" type="number" class="form-control" id="email" placeholder="Phone Number">
                              </fieldset>
                            </div>
                            <div class="col-lg-6 col-md-12 col-sm-12">
                              <fieldset>
                                <input name="district" type="text" class="form-control" id="email" placeholder="District">
                              </fieldset>
                            </div>
                            <div class="col-lg-12">
                              <fieldset>
